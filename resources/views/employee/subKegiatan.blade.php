            ...
            <tbody>
                @foreach($subActivities as $subActivity)
                    <tr>
                        ...
                        <td>{{$subActivity->getActivity->name}}</td>
                        <td>{{$subActivity->getActivity->unit_target}}</td>
                        <td>{{$subActivity->getActivity->target}} {{$subActivity->getActivity->unit_target}}</td>
                        <td>0</td>
                        <td class="text-center">  <a href="/sub-kegiatan/{{$subActivity->id}}/manage-sub-kegiatan" class="btn btn-success btn-sm"> Manage </a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
