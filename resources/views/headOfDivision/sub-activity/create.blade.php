                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="program_id" value="{{$activity->id}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="output">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="bulan" readonly id="satuan">
                                        @elseif($activity->activity_unit_target == 'dokumen')
                                        <input type="text" class="form-control" value="dokumen" readonly id="satuan">
                                        @elseif($activity->activity_unit_target == 'persen')
                                        <select name="unit" class="form-control" required id="satuan">
                                ...
                                <div class="output">
                                    <div class="form-group">
                                        ...
                                        <div id="targetBulan" style="display:none">
                                            ...
                                            <input type="text" class="form-control" value="12" readonly min=1>
                                        </div>

                                        <div id="targetDokumen" style="display:none">
                                            <label for="message">Target (Jumlah Dokumen)</label>
                                            <input type="text" class="form-control" value="Jumlah Dokumen" min=1>
                                        </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 left-margin">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-3 ">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" class="flat" name="pelaksana[]" value="{{$worker->id}}"> {{$worker->name}}
                                </label>
                            </div>
                        </div>
                        @endforeach
