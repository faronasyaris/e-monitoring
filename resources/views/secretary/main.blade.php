          ...
          <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="template/html/index.html">
              ...
              <span class="logo-text ms-2">
                <!-- dark Logo text -->
                <img
                  src="template/assets/images/logo-text.png"
                  alt="homepage"
                  class="light-logo"
                />
              </span>
          ...
          <nav class="sidebar-nav">
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="template/html/charts.html"
                  aria-expanded="false"
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="template/html/widgets.html"
                  aria-expanded="false"
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="template/html/tables.html"
                  aria-expanded="false"
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="template/html/form-basic.html" class="sidebar-link"
                      ><i class="mdi mdi-note-outline"></i
                      ><span class="hide-menu"> Form Basic </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="template/html/form-wizard.html" class="sidebar-link"
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="template/html/pages-buttons.html"
                  aria-expanded="false"
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="template/html/icon-material.html" class="sidebar-link"
                      ><i class="mdi mdi-emoticon"></i
                      ><span class="hide-menu"> Material Icons </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="template/html/icon-fontawesome.html" class="sidebar-link"
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="template/html/pages-elements.html"
                  aria-expanded="false"
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="template/html/index2.html" class="sidebar-link"
                      ><i class="mdi mdi-view-dashboard"></i
                      ><span class="hide-menu"> Dashboard-2 </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="template/html/pages-gallery.html" class="sidebar-link"
                      ><i class="mdi mdi-multiplication-box"></i
                      ><span class="hide-menu"> Gallery </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="template/html/pages-calendar.html" class="sidebar-link"
                      ><i class="mdi mdi-calendar-check"></i
                      ><span class="hide-menu"> Calendar </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="template/html/pages-invoice.html" class="sidebar-link"
                      ><i class="mdi mdi-bulletin-board"></i
                      ><span class="hide-menu"> Invoice </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="template/html/pages-chat.html" class="sidebar-link"
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="template/html/authentication-login.html" class="sidebar-link"
                      ><i class="mdi mdi-all-inclusive"></i
                      ><span class="hide-menu"> Login </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="template/html/authentication-register.html" class="sidebar-link"
                      ><i class="mdi mdi-all-inclusive"></i
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="template/html/error-403.html" class="sidebar-link"
                      ><i class="mdi mdi-alert-octagon"></i
                      ><span class="hide-menu"> Error 403 </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="template/html/error-404.html" class="sidebar-link"
                      ><i class="mdi mdi-alert-octagon"></i
                      ><span class="hide-menu"> Error 404 </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="template/html/error-405.html" class="sidebar-link"
                      ><i class="mdi mdi-alert-octagon"></i
                      ><span class="hide-menu"> Error 405 </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="template/html/error-500.html" class="sidebar-link"
                      ><i class="mdi mdi-alert-octagon"></i
              ...
              <div class="card">
                ...
                <div class="comment-widgets scrollable">
                  ...
                  <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                      <img
                        src="template/assets/images/users/5.jpg"
                        alt="user"
                        width="50"
                        class="rounded-circle"
                      />
                ...
                <div class="card-body">
                  ...
                  <div class="chat-box scrollable" style="height: 475px">
                    ...
                    <ul class="chat-list">
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="template/assets/images/users/2.jpg" alt="user" />
                        </div>
                        <div class="chat-content">
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="template/assets/images/users/3.jpg" alt="user" />
                        </div>
                        <div class="chat-content">
                ...
                <div class="tab-content tabcontent-border">
                  <div class="tab-pane active" id="home" role="tabpanel">
                    <div class="p-20">
                      ...
                      <img
                        src="template/assets/images/background/img4.jpg"
                        class="img-fluid"
                      />
                    </div>
                  </div>
