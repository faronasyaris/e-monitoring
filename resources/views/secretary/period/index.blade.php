            ...
            <tbody>
                @foreach($periods as $periode)
                    <tr>
                        ...
                        <button class="btn btn-danger btn-sm" id="deleteButton" data-id='{{$periode->id}}'>Delete</button>
                    </td>
                    </tr>
                @endforeach
            </tbody>
...
{{-- modal edit --}}
<div class="modal fade" id="editPeriodeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
            ...
            <form method="post" id="editForm">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="" class="form-label">Masukan Periode Tahun</label>
                        <input type="number" id="editYear" name="year" class="form-control" value="" min="2000" max="2099" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
